# Generated by Django 3.2.5 on 2021-08-23 07:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Duration', models.IntegerField(choices=[(3, 'Three Days'), (7, 'One Week'), (14, 'Two Weeks'), (31, 'One Month')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bid', to='auctions.auction_listing')),
